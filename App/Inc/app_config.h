...
#define TEMPERATURE_OPEN_RAW_THRESHOLD   (0U)
#define TEMPERATURE_SHORT_RAW_THRESHOLD  (1023U)
...
#define TEMPERATURE_MIN_TEMP_0P1C        ((int16_t)-400)
#define TEMPERATURE_MAX_TEMP_0P1C        ((int16_t)1500)
